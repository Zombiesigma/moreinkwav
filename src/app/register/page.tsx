...
function RegisterForm() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "INITIALIZED",
        description: "Your identity is synced. Welcome, " + fullName + ".",
      });
        ...
        <CardContent className="p-10 md:p-14">
          <form onSubmit={handleRegister} className="space-y-8">
            <div className="space-y-3 group">
              <label className="text-[10px] uppercase tracking-[0.4em] font-black text-white/40 group-focus-within:text-muted transition-colors">FULL NAME</label>
            ...
            <div className="space-y-3 group">
              <label className="text-[10px] uppercase tracking-[0.4em] font-black text-white/40 group-focus-within:text-muted transition-colors">PHONE</label>
              <div className="relative">
            ...
            >
              {loading ? (
                ...
                <span className="relative z-10 flex items-center gap-4">
                  SYNC <ArrowRight className="h-8 w-8 group-hover:translate-x-3 transition-transform" />
                </span>
              )}
